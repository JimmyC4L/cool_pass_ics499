    ...
    describe('Environment Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/environments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Environment', () => {
                service.create(new Environment(null)).subscribe(received => {
            ...
            it('should update a Environment', () => {
                service.update(new Environment(123)).subscribe(received => {
