...
import { SharedAccountComponent } from 'app/entities/shared-account/shared-account.component';
...
describe('Component Tests', () => {
    describe('SharedAccount Management Component', () => {
        let comp: SharedAccountComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SharedAccountComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sharedAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
