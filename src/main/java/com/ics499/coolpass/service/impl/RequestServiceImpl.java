...
import com.ics499.coolpass.service.RequestService;
import com.ics499.coolpass.domain.Request;
import com.ics499.coolpass.repository.RequestRepository;
...
public class RequestServiceImpl implements RequestService {
    ...
    public Request save(Request request) {
        log.debug("Request to save Request : {}", request);        return requestRepository.save(request);
    }
